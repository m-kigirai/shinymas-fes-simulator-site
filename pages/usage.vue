          ...
          <b-row>
            <b-col>
              ...
              <ul>
                <li>
                  2021/07/02 -
                  ユニット総数によってアピール倍率が変化するスキルをテンプレートに実装。
                  興味無視計算の修正。
                </li>
                <li>
                  2020/12/02 -
                ...
                <li>
                  2020/09/13 - 簡易アピール差分早見表の生成機能を追加
                </li>
                <li>
                  2020/09/01 - 詳細モードに【興味DOWN無視】を追加
                </li>
                <li>
                  2020/08/08 -
                  興味DOWNのアビリティ名称を正しい「ひかえめ」に修正 (thx
                  feedback!)
                </li>
                <li>
                  2020/07/07 -
          ...
          <b-row>
            <b-col>
              ...
              <ul>
                ...
                <li>
                  所属ユニットが多いほど効果UP: 最大倍率 * MIN(4, ユニット総数)
                  / 4
                  <ul>
                    <li>所属ユニット4つ以上で最大倍率</li>
                    <li>所属ユニット1つで最低倍率(25%)</li>
                  </ul>
                </li>
              </ul>
              <h3>アピール計算順序</h3>
